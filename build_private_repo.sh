...
mkdir -p $repo_dir_base/share/{common,hadoop,spark,presto}
...
wget https://mirrors.aliyun.com/apache/incubator/druid/0.14.0-incubating/apache-druid-0.14.0-incubating-bin.tar.gz -P ./
...
wget https://mirrors.aliyun.com/apache/kafka/2.1.0/kafka_2.11-2.2.0.tgz -P ./
...
wget https://mirrors.aliyun.com/apache/kylin/apache-kylin-2.6.1/apache-kylin-2.6.1-bin-hbase1x.tar.gz -P ./
...
wget https://mirrors.aliyun.com/apache/storm/apache-storm-1.2.2/apache-storm-1.2.2.tar.gz -P ./
...
wget http://mirrors.aliyun.com/apache/hbase/2.1.3/hbase-2.1.4-bin.tar.gz -O ./hbase-2.1.4.tar.gz
tar -zxvf hbase-2.1.4.tar.gz -C /tmp/
cd /tmp
rm -rf /tmp/hbase-2.1.4/lib/hadoop-*
